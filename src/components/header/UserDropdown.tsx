...
<<<<<<< HEAD
        {/* NOME E SOBRENOME NO CABEÇALHO */}
        <span className="block mr-1 font-medium text-theme-sm">
          {loading ? "..." : `${user?.name || "Karine"} ${user?.lastName || ""}`}
        </span>
...
<<<<<<< HEAD
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 z-50 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark">
            <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-800">
              {/* NOME COMPLETO DENTRO DO MENU */}
              <span className="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">
                {user ? `${user.name} ${user.lastName || ""}` : "Karine Sousa"}
              </span>
              <span className="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">
                {user?.email || "kauthsousa@gmail.com"}
              </span>
            </div>
