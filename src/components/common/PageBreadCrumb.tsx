...
// Definimos a estrutura de cada link extra
...
interface BreadcrumbProps {
  pageTitle: string;
  customLinks?: BreadcrumbLink[]; // O '?' indica que é opcional
}

const PageBreadcrumb: React.FC<BreadcrumbProps> = ({ pageTitle, customLinks }) => {
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
      ...
      <nav>
        <ol className="flex items-center gap-1.5">
          ...
          {/* Renderiza links extras (como 'Clientes') se eles existirem */}
