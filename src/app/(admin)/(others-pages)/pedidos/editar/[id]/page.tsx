...
const EditarPedido = () => {
    const [valorTotal, setValorTotal] = useState<number>(175.00); // Dados fictícios para exemplo
    const [valorEntrada, setValorEntrada] = useState<number>(87.50);

    return (
        <div className="mx-auto max-w-270">
        <PageBreadcrumb pageTitle="Editar Pedido" customLinks={[{ name: "Pedidos", route: "/pedidos" }]} />
